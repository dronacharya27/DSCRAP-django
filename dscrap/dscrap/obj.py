...
def objd(path):
	...
	classFile = "C:/Users/dron/Downloads/DSCRAP django/dscrap/python/coco.names"
	with open(classFile,'rt') as f:
				classNames = f.read().rstrip('\n').split('\n')
				
	configPath = "C:/Users/dron/Downloads/DSCRAP django/dscrap/python/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
	weightsPath = "C:/Users/dron/Downloads/DSCRAP django/dscrap/python/frozen_inference_graph.pb"
